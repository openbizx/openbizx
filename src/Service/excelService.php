...
class excelService
{
    ...
    function renderTSV ($objName)
    {
        ...
        //Log This Export
        Openbizx::$app->getLog()->log(LOG_INFO, "ExcelService", "Export TSV file.");
    }
    ...
    public function importCSV ($objName)
    {
        ...
        $formObj = Openbizx::getObject($objName); // get the existing EasyForm object
    ...
    protected function reportError($error)
    {
        ...
        Openbizx::$app->getClientProxy()->showErrorMessage($errorStr);
    }
}
?>