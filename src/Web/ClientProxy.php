...
use Openbizx\Helpers\DeviceUtil;
...
class ClientProxy
{
    ...
    public function redirectPage($pageURL)
    {
        ...
        if ($pageURL == "#back") {
            ...
            $this->_otherOutput[] = $this->callClientFunction("Openbizx.Net.redirectPage('$pageURL')");
        }
    }
    ...
    public function appendScripts($scriptKey, $scripts, $isFile = true)
    {
        ...
        // add the scripts
        if ($isFile) {
            $_scripts = "<script type='text/javascript' src=\"" . Openbizx::$app->getJsUrl() . "/$scripts\"></script>";
    ...
    public function includeCalendarScripts()
    {
        ...
        $style = "<link rel=\"stylesheet\" href=\"" . Openbizx::$app->getJsUrl() . "/jscalendar/calendar-system.css\" type=\"text/css\">";
        $script = "<script type='text/javascript' src='" . Openbizx::$app->getJsUrl() . "/jscalendar/calendar.js'></script>";
        $script .= "<script type='text/javascript' src='" . Openbizx::$app->getJsUrl() . "/jscalendar/lang/calendar-en.js'></script>";
        $script .= "<script type='text/javascript' src='" . Openbizx::$app->getJsUrl() . "/jscalendar/calendar-setup.js'></script>";
        $script .= "<script type='text/javascript' src='" . Openbizx::$app->getJsUrl() . "/calendar.js'></script>";
    ...
    public function includeColorPickerScripts()
    {
        ...
        $style = "<link rel=\"stylesheet\" href=\"" . Openbizx::$app->getJsUrl() . "/colorpicker/css/colorpicker.css\" type=\"text/css\">";
        if (OPENBIZ_JSLIB_BASE != 'JQUERY') {
            $script = "<script type=\"text/javascript\" src=\"" . Openbizx::$app->getJsUrl() . "/jquery.js\"></script>";
        }
        $script .= "<script type=\"text/javascript\" src=\"" . Openbizx::$app->getJsUrl() . "/colorpicker/js/eye.js\"></script>";
        $script .= "<script type=\"text/javascript\" src=\"" . Openbizx::$app->getJsUrl() . "/colorpicker/js/utils.js\"></script>";
        $script .= "<script type=\"text/javascript\" src=\"" . Openbizx::$app->getJsUrl() . "/colorpicker/js/colorpicker.js\"></script>";
    ...
    public function includeRTEScripts()
    {
        ...
        $script .= "<script language=\"JavaScript\">initRTE('" . Openbizx::$app->getImageUrl() . "/rte/', '../pages/rte/', '', false);</script>";
    ...
    public function includePropWindowScripts()
    {
        ...
        //$style .= "<link rel=\"stylesheet\" href=\"".Openbizx::$app->getJsUrl()."/window/lighting.css\" type=\"text/css\">";
    ...
    public function includeValidatorScripts()
    {
        ...
        $style = "<link rel=\"stylesheet\" href=\"" . Openbizx::$app->getCssUrl() . "/validator.css\" type=\"text/css\">";
