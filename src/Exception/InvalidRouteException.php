 ...
 * 
 * @link https://github.com/openbizx/openbizx/blob/master/src/Exception/InvalidRouteException.php
 * @author Agus Suhartono <agus.suhartono@gmail.com>
 * @since 1.0
 */
class InvalidRouteException extends UserException implements ExceptionInterface
{
